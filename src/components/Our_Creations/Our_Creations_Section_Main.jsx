...
const Our_Creations_Section_Main = () => {
    ...
    const cardData = [
        ...
        },
        {
            ...
            altText: "Soccer Player with red shirt",
        ...
        },
        {
            ...
            altText: "An Image that looks like a fish eye",
